...
<?php 
    ...
    while ($row2 = mysqli_fetch_array($result2)) {
		...
		echo "Total balance: <strong>$total</strong>";

 ?>

    <p><button type="button"><a href = "add_transaction.php">Add Transaction</a></button>
    <a href="display_update_transaction.php">Display and update transaction</a></p>
    </form>

    <div class = "search">
    <form action="search_transaction.php" method="get">
    <p><label><b>Keyword</b></label>
